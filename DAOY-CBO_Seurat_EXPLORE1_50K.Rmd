...
VlnPlot(dyCbo.annotate,
        features = c("SOX2", "ERBB4", "POU3F4", "POU3F2", "OTX2", "FGFBP3"))
```
...
***Cluster 9 - DAOY-CBO sample: gene set enrichment and g:Profiler input for cytoscape***
```{r eval=FALSE, echo=FALSE}
# order the gene list
...
dyCbo.cl9.UPgenes.presto <- dyCbo.genes.presto %>% 
  dplyr::filter(group == "9" & logFC > 0.25) %>%
  dplyr::arrange(desc(auc)) %>% 
  dplyr::select(feature, auc)

nrow(dyCbo.cl9.UPgenes.presto) # 548 genes
```
