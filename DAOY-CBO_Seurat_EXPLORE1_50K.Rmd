...
```{r eval=FALSE, echo=FALSE, HeatmapDaoyCboVSCboClusterCorrelations2, fig.height=6,fig.width=6}
# FOR KNIT DO NOT RE-RUN THIS CODE CHUNK
graphics.off()
par("mar")
par(mar=c(1,1,1,1))
...
```{r eval=FALSE, echo=FALSE, VlnPlotDaoyCellsSox2networkErbb4Nrg3DaoyCbo, fig.height=10, fig.width=12}
# visualise gene expression indicating DAOY cell clusters
VlnPlot(dyCbo.annotate, features = c("PTCH1", "MEIS1", "POU3F2", "FGFBP3", "TWIST1", "LHX9"))
```

```{r eval=FALSE, echo=FALSE, VlnplotsErbb4Sox2otx2, fig.height=9, fig.width=13}
VlnPlot(dyCbo.annotate,
        features = c("POU3F2", "HOXB2", "HOXB-AS1", "MEIS1"))
```


```{r eval=FALSE, echo=FALSE, VlnPlotDaoyCellsGranuleGenesDaoyCbo, fig.width=9, fig.width=13}
# visualise gene expression indicating DAOY cell clusters
VlnPlot(dyCbo.annotate,
        features = c("MEIS1", "DCX", "ZIC1", "ZIC2", "IRX5", "TTYH1"))
```

```{r eval=FALSE, echo=FALSE, VlnPlotDaoyCellsSHHgenesOtx2DaoyCbo, fig.width=9, fig.width=13}
# visualise gene expression indicating DAOY cell clusters
VlnPlot(dyCbo.annotate,
        features = c("TWIST1", "OTX2", "PTCH1", "GLI2", "NNAT", "PROM1"))
```

```{r eval=FALSE, echo=FALSE, VlnPlotDaoyCellsSOX2networkDaoyCbo, fig.height=9, fig.width=13}
VlnPlot(dyCbo.annotate,
        features = c("SOX2", "POU3F2", "FABP7", "OTX2", "ZIC2", "GABRA6"))
```

```{r eval=FALSE, echo=FALSE, VlnPlotGranuleNeuronGenesDaoyCbo, fig.height=17, fig.width=22}
p3a <- VlnPlot(dyCbo.annotate, 
        features = c("NEUROD1")) +
  theme(axis.text = element_text(size = 22),
        axis.title.x = element_blank(),
...
```{r eval=FALSE, echo=FALSE, VlnPlotUniqueMarkersMalignantCellsDaoyCbo, fig.height=17, fig.width=22}
