...
```{r DimPlotPhaseCBOsctClusters}
# there are 12 clusters (0 - 11)
DimPlot(phase.cbo.sct.clusters)
```


```{r ElbowPlotGeneCellFilt}
...
```{r ViolinPlot1CBOnoMitochNoRibo}
...
```{r DotplotSeppMarkers+ciliaMany, fig.height=10}
...
```{r ViolinPlotGranuleLineageByCluster, fig.height=10}
...
VlnPlot(phase.cbo.sct.clusters, features = c("NEUROD1", "CNTN1", "CNTN2", "RBFOX3", "RTN1"))
```

```{r fig.height=10}
VlnPlot(phase.cbo.sct.clusters, features = c("IRX3", "GRIA4", "IRX5", "TWIST1", "PAX3", "MIR124-2HG", 
