...
```{r DimplotDAOYspherUmapSCTransform, fig.height=6, fig.width=10}
...
```{r AddModuleScoreProlifernDAOYspheroid, fig.height=6, fig.width=10}
...
```{r eval=FALSE, echo=FALSE}
# MEIS1 is expressed of these seven
dySpher.POSmarkers %>%
...
```{r eval=FALSE, echo=FALSE}
# tidy up the data - NO significant pathways for cluster 1
...
```{r eval=FALSE, echo=FALSE, ClustreeCBO, fig.height=6}
