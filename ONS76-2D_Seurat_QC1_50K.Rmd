...
fullFilt.ons76.2d.seurat <- readRDS("outputs50K/ONS76_2D/filtCellsGenes.ons76.2d.seurat.rds")
```
...
# Plot the PCA colored by cell cycle phase - cell cycle for G2M vs S not obviously having an effect on clustering, as there is considerable overlap. There is perhaps some clustering/separation for G1 vs G2M/S phases, which is ok and an effect I want to retain.
...
```
# save the seurat.phase object

saveRDS(seurat.phase, "./outputs50K/ONS76_2D/seurat.phase.ons76.2d.rds")
...
```
# SAVE this seurat object from code line 428
