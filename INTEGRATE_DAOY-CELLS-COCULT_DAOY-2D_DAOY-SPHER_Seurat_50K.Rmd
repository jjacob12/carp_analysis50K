...
```{r ViolinPlotNSCmarkersDAOYmonoSpherCocultIntegrated, fig.height=17, fig.width=22}
...
```{r VlnPlotIntegratedNotchDeltaDaoyOnlyCocultVsSpherVs2dAllCells, eval=FALSE, echo=FALSE, fig.height=9, fig.width=12}
...
```{r LineplotGenesOfInterestAvgExpressnDaoyOnlyCocultVsSpherVsMono, eval=FALSE, echo=FALSE, fig.height = 5}
...
```{r LineplotGenesOfInterestLowExpressnGenesAvgExpressnOns76cocultSpherMono, eval=FALSE, echo=FALSE}
...
```{r PlotCorrAllGenesDaoyOnlyCocultVsSpherVsMono, eval=FALSE, echo=FALSE}
...
```{r BarChartCellCounts7samples, eval=FALSE, echo=FALSE, fig.height=6, fig.width=5}
...
```{r DimPlot7samplesMerged, eval=FALSE, echo=FALSE, fig.height=3}
...
```{r PlotCorrAllGenes7samples, eval=FALSE, echo=FALSE, fig.height=6}
# ggplot upper triangular correlation matrix:
