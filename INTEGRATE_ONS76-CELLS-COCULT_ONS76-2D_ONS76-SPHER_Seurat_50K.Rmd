...
```{r VlnPlot4samplesMergedDaoyONS762d3dCNTN1meis1MEIS2jkamp, fig.height=17, fig.width=22}
Idents(dy.o76.2d3d) <- "sample"
...
*****Expression of markers in monolayers vs spheroids*****
```{r eval=FALSE, echo=FALSE}
...
```{r eval=FALSE, echo=FALSE, BarplotFGSEAgoBPons76MONOIntegratedMonoSpher, fig.height=15, fig.width=25}
...
```{r  eval=FALSE, echo=FALSE, BarplotFGSEAgoBPons76SPHEROIDIntegratedMonoSpher, fig.height=15, fig.width=20}
# only plot the top 10 pathways
...
*****Find proliferating cells in ONS76 spheroid and monolayer integrated seurat object*****
