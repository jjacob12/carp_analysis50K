...
```{r BarPlotCellCountsONS76SpherVs2D, fig.height=4, fig.width=3}
metadata %>% 
...
```{r VolcanoPlotONS76SpherVs2D, fig.height=10, fig.width=10}
...
```{r BarChartONS76CellCounts2d3dONS76CboAndCbo4conditions, fig.height=4, fig.width=4}
...
```{r DimPlotMergedDyCboSpher2dCboCNTRL4samples, fig.height=6, fig.width=8}
...
```{r ViolinPlotONS76CboGenesOfInterest, fig.height=10, fig.width=12}
VlnPlot(phase.ons76cbo.sct.clust, 
        features = c("HOXB2", "SOX2", "POU3F2", "FABP7", "GRIA4", "MEIS1", "LHX9", "NEUROD1", "ZIC1"),
        slot = "data", assay = "RNA")
```
...
```{r ViolinPlotCboGenesOfInterest, fig.height=10, fig.width=12}
# HOXB2 not expressed
VlnPlot(phase.cbo.sct.clusters, features = c("HOXB2", "SOX2", "POU3F2", "FABP7", "GRIA4", "MEIS1",
                                             "LHX9", "NEUROD1", "ZIC1"), 
        slot = "data", assay = "RNA")
```
...
```{r DimplotUMAPIntegrationOns76onlyCboVSspher, fig.height=6}
...
```{r VolcanoPlotONS76cocultExtractVsSpher, fig.height=10, fig.width=10}
...
```{r DimPlotONS76Integrated3samplesONS76monoSpherExtractCoculture, fig.height=6}
...
```{r DimplotONS763samplesSCTintegrationMonoVsSperVsCluster9fromONS76CboSample}
...
```{r VlnPlotStemnessGenesONS76CboClust9VsMonoVsSpher3samples, fig.height=15, fig.width=15}
Idents(ons76.4samples.combined.sct2) <- "orig.ident"
VlnPlot(ons76.4samples.combined.sct2, 
        features = c("SOX2", "POU3F2","FABP7", "TTYH1", "ERBB4", "NRG3",                                                       "NNAT","MIR124-2HG", "DCX", "CTNNA2", "MEIS1", "HES6"),
        slot = "data",
        assay = "RNA"
        )
```
...
```{r VlnPlot7samplesMergedDy2d3dcocultONS2d3dclust3AND8clust9SoxPou3F, fig.height=15, fig.width=12}
VlnPlot(daoy.o76.cells,
        features = c("SOX2", "NES", "POU3F2", "MKI67", "TOP2A", "IRX5","MIR124-2HG", "NEUROD1", "DCX", "CTNNA2"),
        slot = "data",
        assay = "RNA")
```


```{r VlnPlot7samplesMergedDy2d3dcocultONS2d3dCocultClust3AND8AND9SOX2Network, fig.height=15, fig.width=12}
VlnPlot(daoy.o76.cells,
        features = c("SOX2", "NES", "POU3F2", "FABP7", "OTX2", "ZIC2", "GLI2"),
        slot = "data",
        assay = "RNA")
```
...
```{r VlnPlot6samplesMergedDy2d3dONS2d3dCocultClust3AND8AND9SOX2Network, fig.height=10, fig.width=12}
...
SOX2 network. POU3F2 is expressed in the ONS76 and DAOY co-cultured cells
...
```{r Heatmap7samplesMergedDy2d3dcocultONS2d3dclust3AND8clust9SmadGenes, fig.height=10, fig.width=12}
...
```{r Heatmap7samplesMergedDy2d3dcocultONS2d3dclust3AND8clust9SHHgenes, fig.height=10, fig.width=12}
...
```{r Heatmap7samplesMergedDy2d3dcocultONS2d3dclust3AND8clust9Notchgenes, fig.height=10, fig.width=12}
