...
VlnPlot(muv41, features = c("NEUROD1", "RBFOX3", "RTN1", "SOX2"))
```
...
```{r eval=FALSE, echo=FALSE, fig.height=6, fig.width=12}
VlnPlot(sj454.clust, features = c("PROM1", "NEUROD1", "RBFOX3", "RTN1"))
```
...
```{r VlnplotSOX2regNetworkSRRTgeneSJ454shhMB, fig.height=14, fig.width=22}
...
```{r eval=FALSE, echo=FALSE, fig.height=6, fig.width=12}
VlnPlot(sj577, features = c("SOX2", "NEUROD1", "RBFOX3", "RTN1"))
```
