...
```{r eval=FALSE, echo=FALSE}
VlnPlot(muv41, features = c("NEUROD1", "RTN1", "RBFOX3"))
```


```{r eval=FALSE, echo=FALSE, ViolinPlotMUV41shhMBneurod1Rtn1Rbfox3, fig.height=5, fig.width=12}
...
# VlnPlot(sj454, features = c("SOX2", "POU5F1", "FABP7", "OTX2", "ZIC2", "GLI2"))
...
# SOX2, GLI2 expressed in 2/3 clustersZIC2 and TBX6 not expressed
VlnPlot(rmcb18.clust, features = c("SOX2", "POU5F1", "TBX6", "OTX2", "SRRT", "GLI2"))
```
...
p2a + p2b + p2c + p2d + p2e + plot_layout(ncol = 2)
```
...
```{r eval=FALSE, echo=FALSE, fig.height=8, fig.width=12}
# ZIC2 and TBX6 is not expressed
