...
Interesting to note that although ONS76-CBO does not have a distinct cluster of ciliated cells (unlike DAOY-CBO and CBO samples), expression of three ciliated cell markers is highest in the RL_derived_2 subpopulation suggesting those ciliated cells were present but not well represented in the ONS76-CBO sample.
```{r eval=FALSE, echo=FALSE, MDM2expression, fig.height=9, fig.width=12}
VlnPlot(o76cbo.annotate, features = c("POU3F2", "HOXB2", "ERBB4", "NRG3", "MEIS1", "MDM2", "FUT4", "FOXJ1", "CCNO", "TEKT1"))
```
...
```{r ViolinPlotSox2networkInclSRRTgeneONS76onlyONS76cbo, fig.height=17, fig.width=22}
# POU5F1 (OCT4) is not expressed, POU3F2, SRRT are expressed
...
```{r eval=FALSE, echo=FALSE, BarplotFGSEAgoBPclust6cboUPregulatedPathways, fig.height=15, fig.width=25}
