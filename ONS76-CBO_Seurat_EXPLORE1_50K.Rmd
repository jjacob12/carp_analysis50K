...
Identify markers that uniquely identify ONS76_cluster8 cells
```{r}
o76cbo.POSmarkers %>% 
...
# these markers uniquely identify ONS76 cluster 8. Little or no expression in other clusters including
# ONS76_cluster 3
VlnPlot(o76cbo.annotate, features = c("MEIS1", "POU3F2", "HOXB2", "GRIA4"))
```
