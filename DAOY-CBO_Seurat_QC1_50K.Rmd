...
seurat.phase <- NormalizeData(fullFilt.daoyCbo.seurat)
```
...
# Plot the PCA colored by cell cycle phase - cell cycle has no obvious effect on clustering, this is even more clear cut than the 20K analysis
...
```
# save the Seurat (seurat.phase) object
saveRDS(seurat.phase, "./outputs50K/DAOY-CBO/seurat.phase.daoyCbo.rds")
```
